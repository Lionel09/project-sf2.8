...
class CmsCategoryTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.App.Model.map.CmsCategoryTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('App\\Model\\CmsCategory');
    ...
    {
        $this->addRelation('CmsContent', 'App\\Model\\CmsContent', RelationMap::ONE_TO_MANY, array('id' => 'cms_category_id', ), 'SET NULL', 'CASCADE', 'CmsContents');
    } // buildRelations()
