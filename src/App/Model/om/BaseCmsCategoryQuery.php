...
abstract class BaseCmsCategoryQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'App\\Model\\CmsCategory';
        }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \App\Model\CmsContentQuery A secondary query class using the current class as primary query
     */
    public function useCmsContentQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinCmsContent($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CmsContent', '\App\Model\CmsContentQuery');
    }
