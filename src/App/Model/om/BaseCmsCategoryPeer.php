...
use \PropelException;
use \PropelPDO;
use App\Model\CmsCategory;
use App\Model\CmsCategoryPeer;
use App\Model\CmsCategoryQuery;
use App\Model\CmsContentPeer;
use App\Model\map\CmsCategoryTableMap;
...
abstract class BaseCmsCategoryPeer
{
    ...
    const OM_CLASS = 'App\\Model\\CmsCategory';

    /** the related TableMap class for this table */
    const TM_CLASS = 'App\\Model\\map\\CmsCategoryTableMap';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Title', 'Online', 'SortableRank', 'CreatedAt', 'UpdatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'title', 'online', 'sortableRank', 'createdAt', 'updatedAt', ),
        BasePeer::TYPE_COLNAME => array (CmsCategoryPeer::ID, CmsCategoryPeer::TITLE, CmsCategoryPeer::ONLINE, CmsCategoryPeer::SORTABLE_RANK, CmsCategoryPeer::CREATED_AT, CmsCategoryPeer::UPDATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'TITLE', 'ONLINE', 'SORTABLE_RANK', 'CREATED_AT', 'UPDATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'title', 'online', 'sortable_rank', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Title' => 1, 'Online' => 2, 'SortableRank' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'title' => 1, 'online' => 2, 'sortableRank' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        BasePeer::TYPE_COLNAME => array (CmsCategoryPeer::ID => 0, CmsCategoryPeer::TITLE => 1, CmsCategoryPeer::ONLINE => 2, CmsCategoryPeer::SORTABLE_RANK => 3, CmsCategoryPeer::CREATED_AT => 4, CmsCategoryPeer::UPDATED_AT => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'TITLE' => 1, 'ONLINE' => 2, 'SORTABLE_RANK' => 3, 'CREATED_AT' => 4, 'UPDATED_AT' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'title' => 1, 'online' => 2, 'sortable_rank' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCmsCategoryPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \App\Model\map\CmsCategoryTableMap());
      }
    }
