...
abstract class BaseCmsContentQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'App\\Model\\CmsContent';
        }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \App\Model\CmsCategoryQuery A secondary query class using the current class as primary query
     */
    public function useCmsCategoryQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinCmsCategory($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CmsCategory', '\App\Model\CmsCategoryQuery');
    }
