...
use \PropelException;
use \PropelPDO;
use App\Model\CmsCategoryPeer;
use App\Model\CmsContent;
use App\Model\CmsContentPeer;
use App\Model\map\CmsContentTableMap;
...
abstract class BaseCmsContentPeer
{
    ...
    const OM_CLASS = 'App\\Model\\CmsContent';

    /** the related TableMap class for this table */
    const TM_CLASS = 'App\\Model\\map\\CmsContentTableMap';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'CmsCategoryId', 'Title', 'Summary', 'Description', 'Online', 'CreatedAt', 'UpdatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'cmsCategoryId', 'title', 'summary', 'description', 'online', 'createdAt', 'updatedAt', ),
        BasePeer::TYPE_COLNAME => array (CmsContentPeer::ID, CmsContentPeer::CMS_CATEGORY_ID, CmsContentPeer::TITLE, CmsContentPeer::SUMMARY, CmsContentPeer::DESCRIPTION, CmsContentPeer::ONLINE, CmsContentPeer::CREATED_AT, CmsContentPeer::UPDATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'CMS_CATEGORY_ID', 'TITLE', 'SUMMARY', 'DESCRIPTION', 'ONLINE', 'CREATED_AT', 'UPDATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'cms_category_id', 'title', 'summary', 'description', 'online', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'CmsCategoryId' => 1, 'Title' => 2, 'Summary' => 3, 'Description' => 4, 'Online' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'cmsCategoryId' => 1, 'title' => 2, 'summary' => 3, 'description' => 4, 'online' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        BasePeer::TYPE_COLNAME => array (CmsContentPeer::ID => 0, CmsContentPeer::CMS_CATEGORY_ID => 1, CmsContentPeer::TITLE => 2, CmsContentPeer::SUMMARY => 3, CmsContentPeer::DESCRIPTION => 4, CmsContentPeer::ONLINE => 5, CmsContentPeer::CREATED_AT => 6, CmsContentPeer::UPDATED_AT => 7, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'CMS_CATEGORY_ID' => 1, 'TITLE' => 2, 'SUMMARY' => 3, 'DESCRIPTION' => 4, 'ONLINE' => 5, 'CREATED_AT' => 6, 'UPDATED_AT' => 7, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'cms_category_id' => 1, 'title' => 2, 'summary' => 3, 'description' => 4, 'online' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCmsContentPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \App\Model\map\CmsContentTableMap());
      }
    }
