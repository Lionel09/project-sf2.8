...
use Model\map\CmsCategoryTableMap;
...
abstract class BaseCmsCategoryPeer
{
    ...
    const OM_CLASS = 'Model\\CmsCategory';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Model\\map\\CmsCategoryTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCmsCategoryPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Model\map\CmsCategoryTableMap());
      }
    }
