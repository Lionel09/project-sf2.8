...
use Model\map\CmsContentTableMap;
...
abstract class BaseCmsContentPeer
{
    ...
    const OM_CLASS = 'Model\\CmsContent';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Model\\map\\CmsContentTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCmsContentPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Model\map\CmsContentTableMap());
      }
    }
