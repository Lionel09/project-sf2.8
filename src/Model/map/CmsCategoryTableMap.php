...
class CmsCategoryTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Model.map.CmsCategoryTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Model\\CmsCategory');
    ...
    {
        $this->addRelation('CmsContent', 'Model\\CmsContent', RelationMap::ONE_TO_MANY, array('id' => 'cms_category_id', ), 'SET NULL', 'CASCADE', 'CmsContents');
    } // buildRelations()
